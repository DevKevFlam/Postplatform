...
public class MyUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(final String email) throws UsernameNotFoundException {
        ...
        try {
            ...
            return new org.springframework.security.core.userdetails.User(user.getEmail(), user.getPassword(), user.isEnabled(), true, true, true, getAuthorities(user.getRoleUser()));
    ...
    private final Collection<? extends GrantedAuthority> getAuthorities(final RoleUser role) {
